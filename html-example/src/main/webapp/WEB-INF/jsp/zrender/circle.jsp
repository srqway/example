...
<script src='<c:url value="/javascript/requirejs-master/require.js"></c:url>'></script>
</head>
<body>
    ...
    require.config({
        paths:{ 
            zrender:'<c:url value="/javascript/zrender-2.0.8/doc/example/www/js/zrender"></c:url>',
            'zrender/shape/Circle' : '<c:url value="/javascript/zrender-2.0.8/doc/example/www/js/zrender"></c:url>'
        }
    });
