		...
		require
				.config({
					paths : {
						...
						'zrender/shape/Heart' : '<c:url value="/javascript/zrender-2.0.8/build/zrender"></c:url>'
					}
				});
		require([ 'zrender', 'zrender/shape/Heart' ], function(zrender, heart) {
			var zr = zrender.init(document.getElementById('main'));
			var shapeId = require('zrender/tool/guid')();
			zr.addShape(new heart({
				id : shapeId,
				style : {
					x : 100,
					y : 100,
