		...
		require
				.config({
					paths : {
						...
						'zrender/shape/Rose' : '<c:url value="/javascript/zrender-2.0.8/build/zrender"></c:url>'
					}
				});
		require([ 'zrender', 'zrender/shape/Rose' ], function(zrender, rose) {
			var zr = zrender.init(document.getElementById('main'));
			var shapeId = require('zrender/tool/guid')();
			zr.addShape(new rose({
				id : shapeId,
				style : {
					x : 200,
					y : 200,
